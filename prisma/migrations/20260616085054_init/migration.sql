-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'DELIVERY', 'USER');

-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('BABY_FOOD', 'FRUIT');

-- CreateEnum
CREATE TYPE "AvailabilityType" AS ENUM ('STOCK', 'PRE_ORDER');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('CONFIRMED', 'PROCESSED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'RETURN_REQUESTED', 'RETURNED', 'CANCELLED');
